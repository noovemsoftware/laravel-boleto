...
class Santander extends AbstractRetorno implements RetornoCnab400
{
    ...
    protected function processarDetalhe(array $detalhe)
    {
        ...
        if ($d->hasOcorrencia('06', '07', '08', '16', '17')) {
            ...
            $error = [];
            $error[] = array_get($this->rejeicoes, $grupoErro . $errorsRetorno[0], '');
            $error[] = array_get($this->rejeicoes, $grupoErro . $errorsRetorno[1], '');
            $error[] = array_get($this->rejeicoes, $grupoErro . $errorsRetorno[2], '');

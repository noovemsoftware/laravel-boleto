    ...
    protected function processarDetalhe(array $detalhe)
    {
        ...
        if ($this->usandoCentavos) {
            $d->setValor((int) $this->rem(153, 165, $detalhe))
                ...
                ->setValorMulta((int) $this->rem(202, 214, $detalhe))
                ...
                ->setValorMora((int) $this->rem(280, 292, $detalhe))
            ...
            $d->setValor((float) Util::nFloat($this->rem(153, 165, $detalhe) / 100, 2, false))
                ...
                ->setValorMulta((float) Util::nFloat($this->rem(202, 214, $detalhe) / 100, 2, false))
                ...
                ->setValorMora((float) Util::nFloat($this->rem(280, 292, $detalhe) / 100, 2, false))

...
class Santander extends AbstractRemessa implements RemessaContract
{
    ...
    const ESPECIE_BOLETO_PROPOSTA = '08';
    const ESPECIE_BOLETO_CARTAO_CREDITO = '19';
    ...
    public function addBoleto(BoletoContract $boleto)
    {
        ...
        if ($this->getCarteiraNumero() == 5) {
            $this->add(143, 147, Util::formatCnab('9', $this->getAgencia(), 4));
        } else {
    ...
    protected function trailer()
    {
        ...
        if ($this->usandoCentavos) {
            $this->add(8, 20, Util::formatCnab('9', $this->total, 13));
        } else {
